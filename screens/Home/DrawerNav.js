...
const CustomDrawerContent = (props) => {
  ...
  return (
    <DrawerContentScrollView {...props} contentContainerStyle={{flexDirection: 'column',justifyContent: 'space-between', height: '97%'}}>
    ...
    <Background>
      <Drawer.Navigator
        screenOptions={{ 
          ...
          headerTitle: (props) => <LiboraLogo width={80} {...props}/> ,
        }}
