...
import Reading from './Home/Reading'
  ...
  return (
    <Background>
      <Tab.Navigator screenOptions={{
        ...
        <Tab.Screen name="Reading" component={Reading} options={{tabBarIcon: ({size ,color}) => <ReadingIcon width='29' height='29' style={{marginVertical: 5}} fill={color} /> }} />
